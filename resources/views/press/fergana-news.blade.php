            ...
            <div class="swiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide blog">
                        @foreach ($ferganes as $fergana)
                         <a href="{{ route('press.fergana_news_details', ['fergana'=> $fergana->id]) }}" class="s-card swiper-slide">
                            <div class="bg-i">
                                <img class="top" src="{{ asset('storage/'.$fergana->photo) }}" alt="">
                            </div>
