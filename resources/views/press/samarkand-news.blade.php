                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide blog">
                        @foreach ($samarkands as $samarkand)
                         <a href="{{ route('press.samarkand_news_details', ['samarkand'=> $samarkand->id]) }}" class="s-card swiper-slide">
                            <div class="bg-i">
                                <img class="top" src="{{ asset('storage/'.$samarkand->photo) }}" alt="">
                            </div>
