                                  ...
                                  <form action="{{ route('structures.update', ['structure'=>$structure->id])}}" method="POST" class="row">
                                    ...
                                    @csrf
                                     <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="editor" value="{!! $structure->title !!}" id="posttitle" name="title" placeholder="Enter title" required>
                                     </div>
                                     <div class="row">
                                        <div class="col-sm-12">
                                           <div class="card-box">
                                              <h4 class="m-b-30 m-t-0 header-title"><b>Description</b></h4>
                                              <textarea  name="description" id="editors" required>{!! $structure->description !!}</textarea>
                                           </div>
                                        </div>
                                     </div>
