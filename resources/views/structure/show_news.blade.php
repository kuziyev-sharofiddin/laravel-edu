<x-layouts.admin>
    @slot('title')
        Struktura ma'lumotlarini boshqarish
    @endslot
      ...
      <div class="row">
         <div class="col-xs-12">
            <div class="page-title-box">
               <h4 class="page-title">Manage Structures </h4>
                  ...
                  <table class="table table-bordered" id="example">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td><div><a  class="btn btn-primary btn-sm" href="{{ route('structures.edit', ['structure'=>$structure->id]) }}"><i class="fa fa-pencil"></i></a>
                            <form action="{{ route('structures.destroy', ['structure'=>$structure->id]) }}" method="POST" onsubmit="return confirm('Rostan ham o\'chirishni xohlaysizmi?')">
                                @csrf
                                @method('DELETE')
