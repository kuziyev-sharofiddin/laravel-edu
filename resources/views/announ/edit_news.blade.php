                         ...
                         <div class="col-xs-12">
                            <div class="page-title-box">
                               ...
                               <ol class="breadcrumb p-0 m-0">
                                  ...
                                  <li>
                                     <a href="{{ route('announcements.index')}}">Manage Announcement</a>
                                  </li>
                                  <li class="active">
                                    Edit Announcement
                                  </li>
                         ...
                         <div class="col-sm-6">
                            ...
                            <div class="alert alert-danger" role="alert">
                               <strong>Oh snap!</strong>
                                  ...
                                  <form action="{{ route('announcements.update', ['announcement'=>$announcement->id])}}" method="POST" class="row" enctype="multipart/form-data">
                                    @method('PUT')
                                    @csrf
