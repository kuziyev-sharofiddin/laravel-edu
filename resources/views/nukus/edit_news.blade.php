                                  ...
                                  <form action="{{ route('nukuses.update', ['nukus'=>$nukus->id])}}" method="POST" class="row" enctype="multipart/form-data">
                                    ...
                                    @csrf
                                     <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="editor" value="{{ $nukus->title }}" id="posttitle" name="title" placeholder="Enter title" required>
                                     </div>
                                     <div class="row">
                                        <div class="col-sm-12">
                                           <div class="card-box">
                                              <h4 class="m-b-30 m-t-0 header-title"><b>Description</b></h4>
                                              <textarea  name="description" id="editors" required>{!! $nukus->description !!}</textarea>
                                           </div>
                                        </div>
                                     </div>
                                     <div class="row">
