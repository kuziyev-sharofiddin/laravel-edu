<x-layouts.admin>
    @slot('title')
    Nukus News ma'lumotlarini qo'shish
    @endslot
                  ...
                  <div class="row">
                     <div class="col-xs-12">
                        <div class="page-title-box">
                           <h4 class="page-title">Add Nukus News </h4>
                     ...
                     <div class="col-sm-6">
                        ...
                        <div class="alert alert-danger" role="alert">
                           <strong>Oh snap!</strong>
                              ...
                              <form action="{{ route('nukuses.store')}}" method="POST" class="row" enctype="multipart/form-data">
                                @csrf
