                  ...
                  <div class="row">
                     <div class="col-xs-12">
                        <div class="page-title-box">
                           <h4 class="page-title">Add Video News</h4>
                     ...
                     <div class="col-sm-6">
                        ...
                        <div class="alert alert-danger" role="alert">
                           <strong>Oh snap!</strong>
                              ...
                              <form action="{{ route('videos.store')}}" method="POST" class="row" enctype="multipart/form-data">
                                @csrf
                                 ...
                                 <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="posttitle" name="youtube" placeholder="Enter title" required>
                                 </div>
                                 <div class="row">
                                    <div class="col-sm-12">
                                       <div class="card-box">
