<x-layouts.admin>
    @slot('title')
    Samarkand News ma'lumotlarini qo'shish
    @endslot
                  ...
                  <div class="row">
                     <div class="col-xs-12">
                        <div class="page-title-box">
                           <h4 class="page-title">Add Samarkand News</h4>
                     ...
                     <div class="col-sm-6">
                        ...
                        <div class="alert alert-danger" role="alert">
                           <strong>Oh snap!</strong>
                              ...
                              <form action="{{ route('samarkands.store')}}" method="POST" class="row" enctype="multipart/form-data">
                                @csrf
